    ...
    return {
        ...
        args = {
            ...
            enabled = {
                ...
                order = 2,
                get = function()
                    local cfg = LilyUI.db.profile.buffBarViewer or {}
                    return cfg.enabled ~= false
                end,
                set = function(_, val)
                    LilyUI.db.profile.buffBarViewer.enabled = val
                    if LilyUI.RefreshViewers then
                        LilyUI:RefreshViewers()
                    end
                end,
            },
            width = {
                ...
                set = function(_, val)
                    LilyUI.db.profile.buffBarViewer.width = val
                    if LilyUI.RefreshViewers then
                        LilyUI:RefreshViewers()
                    end
                end,
            ...
            height = {
                ...
                set = function(_, val)
                    LilyUI.db.profile.buffBarViewer.height = val
                    if LilyUI.RefreshViewers then
                        LilyUI:RefreshViewers()
                    end
                end,
            ...
            texture = {
                ...
                set = function(_, val)
                    ...
                    LilyUI.db.profile.buffBarViewer.texture = val
                    if LilyUI.RefreshViewers then
                        LilyUI:RefreshViewers()
                    end
                end,
            ...
            bgColor = {
                ...
                set = function(_, r, g, b, a)
                    ...
                    LilyUI.db.profile.buffBarViewer = cfg
                    if LilyUI.RefreshViewers then
                        LilyUI:RefreshViewers()
                    end
                end,
            ...
            hideIconMask = {
                ...
                set = function(_, val)
                    LilyUI.db.profile.buffBarViewer.hideIconMask = val
                    if LilyUI.RefreshViewers then
                        LilyUI:RefreshViewers()
                    end
                end,
            ...
            hideIcon = {
                ...
                set = function(_, val)
                    LilyUI.db.profile.buffBarViewer.hideIcon = val
                    if LilyUI.RefreshViewers then
                        LilyUI:RefreshViewers()
                    end
                end,
            ...
            iconZoom = {
                ...
                set = function(_, val)
                    LilyUI.db.profile.buffBarViewer.iconZoom = val
                    if LilyUI.RefreshViewers then
                        LilyUI:RefreshViewers()
                    end
                end,
            ...
            iconBorderSize = {
                ...
                set = function(_, val)
                    LilyUI.db.profile.buffBarViewer.iconBorderSize = val
                    if LilyUI.RefreshViewers then
                        LilyUI:RefreshViewers()
                    end
                end,
            ...
            showName = {
                ...
                set = function(_, val)
                    LilyUI.db.profile.buffBarViewer.showName = val
                    if LilyUI.RefreshViewers then
                        LilyUI:RefreshViewers()
                    end
                end,
            ...
            nameSize = {
                ...
                set = function(_, val)
                    LilyUI.db.profile.buffBarViewer.nameSize = val
                    if LilyUI.RefreshViewers then
                        LilyUI:RefreshViewers()
                    end
                end,
            ...
            nameAnchor = {
                ...
                set = function(_, val)
                    ...
                    LilyUI.db.profile.buffBarViewer.nameAnchor = val
                    if LilyUI.RefreshViewers then
                        LilyUI:RefreshViewers()
                    end
                end,
            ...
            nameOffsetX = {
                ...
                set = function(_, val)
                    LilyUI.db.profile.buffBarViewer.nameOffsetX = val
                    if LilyUI.RefreshViewers then
                        LilyUI:RefreshViewers()
                    end
                end,
            ...
            nameOffsetY = {
                ...
                set = function(_, val)
                    LilyUI.db.profile.buffBarViewer.nameOffsetY = val
                    if LilyUI.RefreshViewers then
                        LilyUI:RefreshViewers()
                    end
                end,
            ...
            showDuration = {
                ...
                set = function(_, val)
                    LilyUI.db.profile.buffBarViewer.showDuration = val
                    if LilyUI.RefreshViewers then
                        LilyUI:RefreshViewers()
                    end
                end,
            ...
            durationSize = {
                ...
                set = function(_, val)
                    LilyUI.db.profile.buffBarViewer.durationSize = val
                    if LilyUI.RefreshViewers then
                        LilyUI:RefreshViewers()
                    end
                end,
            ...
            durationAnchor = {
                ...
                set = function(_, val)
                    if val == "MIDDLE" then val = "CENTER" end
                    LilyUI.db.profile.buffBarViewer.durationAnchor = val
                    if LilyUI.RefreshViewers then
                        LilyUI:RefreshViewers()
                    end
                end,
            ...
            durationOffsetX = {
                ...
                set = function(_, val)
                    LilyUI.db.profile.buffBarViewer.durationOffsetX = val
                    if LilyUI.RefreshViewers then
                        LilyUI:RefreshViewers()
                    end
                end,
            ...
            durationOffsetY = {
                ...
                set = function(_, val)
                    LilyUI.db.profile.buffBarViewer.durationOffsetY = val
                    if LilyUI.RefreshViewers then
                        LilyUI:RefreshViewers()
                    end
                end,
            ...
            showApplications = {
                ...
                set = function(_, val)
                    LilyUI.db.profile.buffBarViewer.showApplications = val
                    if LilyUI.RefreshViewers then
                        LilyUI:RefreshViewers()
                    end
                end,
            ...
            applicationsSize = {
                ...
                set = function(_, val)
                    LilyUI.db.profile.buffBarViewer.applicationsSize = val
                    if LilyUI.RefreshViewers then
                        LilyUI:RefreshViewers()
                    end
                end,
            ...
            applicationsAnchor = {
                ...
                set = function(_, val)
                    if val == "MIDDLE" then val = "CENTER" end
                    LilyUI.db.profile.buffBarViewer.applicationsAnchor = val
                    if LilyUI.RefreshViewers then
                        LilyUI:RefreshViewers()
                    end
                end,
            ...
            applicationsOffsetX = {
                ...
                set = function(_, val)
                    LilyUI.db.profile.buffBarViewer.applicationsOffsetX = val
                    if LilyUI.RefreshViewers then
                        LilyUI:RefreshViewers()
                    end
                end,
            ...
            applicationsOffsetY = {
                ...
                set = function(_, val)
                    LilyUI.db.profile.buffBarViewer.applicationsOffsetY = val
                    if LilyUI.RefreshViewers then
                        LilyUI:RefreshViewers()
                    end
                end,
            ...
            barSpacing = {
                ...
                set = function(_, val)
                    LilyUI.db.profile.buffBarViewer.barSpacing = val
                    if LilyUI.RefreshViewers then
                        LilyUI:RefreshViewers()
                    end
                end,
    ...
    local ret = {
        ...
        args = {
            ...
            enabled = {
                ...
                width = "full",
                order = 2,
                get = function() return LilyUI.db.profile.viewers[viewerKey].enabled end,
                set = function(_, val)
                    LilyUI.db.profile.viewers[viewerKey].enabled = val
                    LilyUI:RefreshAll()
                end,
            },
            spacer1 = {
            ...
            layoutGroup = {
                ...
                args = {
                    iconSize = {
                        ...
                        get = function() return LilyUI.db.profile.viewers[viewerKey].iconSize end,
                        set = function(_, val)
                            LilyUI.db.profile.viewers[viewerKey].iconSize = val
                            LilyUI:RefreshAll()
                        end,
                    },
                    aspectRatio = {
                        ...
                        get = function() 
                            local profile = LilyUI.db.profile.viewers[viewerKey]
                    ...
                    spacing = {
                        ...
                        get = function() return LilyUI.db.profile.viewers[viewerKey].spacing end,
                        set = function(_, val)
                            LilyUI.db.profile.viewers[viewerKey].spacing = val
                            LilyUI:RefreshAll()
                        end,
                    },
                    zoom = {
                        ...
                        width = "full",
                        min = 0, max = 0.2, step = 0.01,
                        get = function() return LilyUI.db.profile.viewers[viewerKey].zoom end,
                        set = function(_, val)
                            LilyUI.db.profile.viewers[viewerKey].zoom = val
                            LilyUI:RefreshAll()
                        end,
                    },
                    rowLimit = {
                        ...
                        width = "full",
                        min = 0, max = 20, step = 1,
                        get = function() return LilyUI.db.profile.viewers[viewerKey].rowLimit or 0 end,
                        set = function(_, val)
                            LilyUI.db.profile.viewers[viewerKey].rowLimit = val
                            LilyUI:RefreshAll()
                        end,
                    },
                    rowGrowDirection = {
                        ...
                        get = function()
                            return LilyUI.db.profile.viewers[viewerKey].rowGrowDirection or "down"
                        end,
                        set = function(_, val)
                            if viewerKey == "BuffIconCooldownViewer" then
                                LilyUI.db.profile.viewers[viewerKey].rowGrowDirection = val
                                LilyUI:RefreshAll()
                            end
                        end,
                    },
            ...
            borderGroup = {
                ...
                args = {
                    borderSize = {
                        ...
                        width = "full",
                        min = 0, max = 5, step = 1,
                        get = function() return LilyUI.db.profile.viewers[viewerKey].borderSize end,
                        set = function(_, val)
                            LilyUI.db.profile.viewers[viewerKey].borderSize = val
                            LilyUI:RefreshAll()
                        end,
                    },
                },
            ...
            textGroup = {
                ...
                args = {
                    countTextSize = {
                        ...
                        width = "full",
                        min = 6, max = 32, step = 1,
                        get = function() return LilyUI.db.profile.viewers[viewerKey].countTextSize or 16 end,
                        set = function(_, val)
                            LilyUI.db.profile.viewers[viewerKey].countTextSize = val
                            LilyUI:RefreshAll()
                        end,
                    },
                    chargeTextAnchor = {
                        ...
                        values = GetChargeAnchorOptions(),
                        get = function()
                            return LilyUI.db.profile.viewers[viewerKey].chargeTextAnchor or "BOTTOMRIGHT"
                        end,
                        set = function(_, val)
                            LilyUI.db.profile.viewers[viewerKey].chargeTextAnchor = val
                            LilyUI:RefreshAll()
                        end,
                    },
                    countTextOffsetX = {
                        ...
                        min = -50, max = 50, step = 1,
                        get = function()
                            return LilyUI.db.profile.viewers[viewerKey].countTextOffsetX or 0
                        end,
                        set = function(_, val)
                            LilyUI.db.profile.viewers[viewerKey].countTextOffsetX = val
                            LilyUI:RefreshAll()
                        end,
                    },
                    countTextOffsetY = {
                        ...
                        min = -50, max = 50, step = 1,
                        get = function()
                            return LilyUI.db.profile.viewers[viewerKey].countTextOffsetY or 0
                        end,
                        set = function(_, val)
                            LilyUI.db.profile.viewers[viewerKey].countTextOffsetY = val
                            LilyUI:RefreshAll()
                        end,
                    },
                },
...
function LilyUI:SetupOptions()
    ...
    if AceDBOptions and self.db then
        ...
        if not self.db.sv or not self.db.keys then
            error("lilyUI: Database not properly initialized! Cannot create profile options.")
        end
        ...
        if profileOptions and profileOptions.handler then
            if profileOptions.handler.db ~= self.db then
                error("lilyUI: Profile options handler is not bound to the correct database!")
            end
        end
            ...
            general = {
                ...
                args = {
                    ...
                    globalTexture = {
                        ...
                        set = function(_, val)
                            LilyUI.db.profile.general.globalTexture = val
                            if LilyUI.RefreshAll then
                                LilyUI:RefreshAll()
                            end
                        end,
                    },
                    ...
                    applyGlobalFontToBlizzard = {
                        ...
                        desc = "When enabled, the global font will also change Blizzard's default UI fonts (tooltips, quest tracker, chat, etc.). When disabled, only LilyUI elements will use the global font.",
                        order = 19.5,
                        width = "full",
                        get = function()
                            return LilyUI.db.profile.general.applyGlobalFontToBlizzard or false
                        end,
                        set = function(_, val)
                            LilyUI.db.profile.general.applyGlobalFontToBlizzard = val
                            -- Reset hook flags so hooks can be recreated if needed
                            if LilyUI._questFontHooked then
                                LilyUI._questFontHooked = nil
                            end
                            if LilyUI._tooltipFontHooked then
                                LilyUI._tooltipFontHooked = nil
                            end
                            if LilyUI._chatFontHooked then
                                LilyUI._chatFontHooked = nil
                            end
                            if LilyUI.ApplyGlobalFont then
                                LilyUI:ApplyGlobalFont()
                            end
                        end,
                    },
                    ...
                    globalFont = {
                        type = "select",
                        name = "Global Font",
                        desc = "Font used globally across all LilyUI elements (viewers, auras, cast bars, etc.). Use the toggle above to also apply to Blizzard's UI.",
                        order = 20,
                        width = "full",
                        values = function()
                        ...
                        get = function()
                            return LilyUI.db.profile.general.globalFont or "Expressway"
                        end,
                        set = function(_, val)
                            LilyUI.db.profile.general.globalFont = val
                            if LilyUI.ApplyGlobalFont then
                                LilyUI:ApplyGlobalFont()
                            end
                            if LilyUI.RefreshAll then
                    ...
                    uiAccentColor = {
                        ...
                        desc = "Controls the accent color used by LilyUI's configuration UI (and other themed elements).",
                        order = 26,
                        width = "full",
                        hasAlpha = false,
                        get = function()
                            local c = (LilyUI.db.profile.general and LilyUI.db.profile.general.colorScheme) or { 1.0, 0.25, 0.65, 1.0 }
                            return c[1] or 1.0, c[2] or 0.25, c[3] or 0.65
                        end,
                        set = function(_, r, g, b)
                            LilyUI.db.profile.general.colorScheme = { r, g, b, 1.0 }
                            if LilyUI.ApplyColorScheme then
                                LilyUI:ApplyColorScheme()
                            end
                            -- Refresh addon visuals
                            if LilyUI.RefreshAll then
                                LilyUI:RefreshAll()
                            end
                            -- Rebuild the config GUI if it's open so the new theme applies immediately
                            if LilyUI.RebuildConfigGUI then
                                LilyUI:RebuildConfigGUI()
                            end
                        end,
                    },
                    resetUIColor = {
                        ...
                        width = "full",
                        func = function()
                            LilyUI.db.profile.general.colorScheme = { 1.0, 0.25, 0.65, 1.0 }
                            if LilyUI.ApplyColorScheme then
                                LilyUI:ApplyColorScheme()
                            end
                            if LilyUI.RefreshAll then
...
uiBackdropStyle = {
    type = "select",
    name = "UI Backdrop",
    desc = "Backdrop art for LilyUI's configuration window.",
    order = 28,
    width = "full",
    values = {
        Default = "Default (Flat)",
        VoidPurple = "Purple Void",
    },
    get = function()
        return LilyUI.db.profile.general.uiBackdropStyle or "Default"
    end,
    set = function(_, val)
        LilyUI.db.profile.general.uiBackdropStyle = val
        if LilyUI.RebuildConfigGUI then
            LilyUI:RebuildConfigGUI()
        end
    end,
                    ...
                    uiScale = {
                        ...
                        get = function()
                            ...
                            local savedScale = LilyUI.db.profile.general.uiScale
                        ...
                        set = function(_, val)
                            ...
                            if numValue then
                                ...
                                LilyUI.db.profile.general.uiScale = numValue
                    ...
                    confirmUIScale = {
                        ...
                        func = function()
                            ...
                            if savedScale and type(savedScale) == "number" then
                                ...
                                LilyUI.db.profile.general.uiScale = savedScale
                                -- Apply the scale
                                if LilyUI.AutoUIScale and LilyUI.AutoUIScale.SetUIScale then
                                    LilyUI.AutoUIScale:SetUIScale(savedScale)
                                    print("|cff00ff00[LilyUI] UI Scale set to " .. string.format("%.8f", savedScale) .. "|r")
                                end
                                ...
                                print("|cffff0000[LilyUI] Invalid UI scale value. Please enter a number between 0.33 and 1.0|r")
                            end
                        end,
                    },
                    ...
                    preset1080p = {
                        ...
                        func = function()
                            ...
                            LilyUI.db.profile.general.uiScale = scale1080p
                            -- Apply the scale
                            if LilyUI.AutoUIScale and LilyUI.AutoUIScale.SetUIScale then
                                LilyUI.AutoUIScale:SetUIScale(scale1080p)
                                print("|cff00ff00[LilyUI] UI Scale set to 0.711111 for 1080p|r")
                            end
                            -- Refresh config to update the input field
                            local AceConfigRegistry = LibStub("AceConfigRegistry-3.0", true)
                            if AceConfigRegistry then
                    ...
                    preset1440p = {
                        ...
                        func = function()
                            ...
                            LilyUI.db.profile.general.uiScale = scale1440p
                            -- Apply the scale
                            if LilyUI.AutoUIScale and LilyUI.AutoUIScale.SetUIScale then
                                LilyUI.AutoUIScale:SetUIScale(scale1440p)
                                print("|cff00ff00[LilyUI] UI Scale set to 0.53333333 for 1440p|r")
                            end
                            -- Refresh config to update the input field
                            local AceConfigRegistry = LibStub("AceConfigRegistry-3.0", true)
                            if AceConfigRegistry then
                    ...
                    general = {
                        ...
                        args = {
                            ...
                            procGlowEnabled = {
                                ...
                                order = 11,
                                get = function()
                                    local procGlow = LilyUI.db.profile.viewers.general.procGlow
                                    return procGlow and procGlow.enabled or false
                                end,
                                set = function(_, val)
                                    if not LilyUI.db.profile.viewers.general.procGlow then
                                        LilyUI.db.profile.viewers.general.procGlow = {}
                                    end
                                    LilyUI.db.profile.viewers.general.procGlow.enabled = val
                                    if LilyUI.ProcGlow and LilyUI.ProcGlow.RefreshAll then
                                        LilyUI.ProcGlow:RefreshAll()
                                    end
                                end,
                            },
                            procGlowSpacer1 = {
                            ...
                            glowType = {
                                ...
                                values = function()
                                    local result = {}
                                    if LilyUI.ProcGlow and LilyUI.ProcGlow.LibCustomGlowTypes then
                                        for _, glowType in ipairs(LilyUI.ProcGlow.LibCustomGlowTypes) do
                                ...
                                set = function(_, val)
                                    ...
                                    LilyUI.db.profile.viewers.general.procGlow.glowType = val
                                    if LilyUI.ProcGlow and LilyUI.ProcGlow.RefreshAll then
                                        LilyUI.ProcGlow:RefreshAll()
                                    end
                                end,
                            ...
                            loopColor = {
                                ...
                                set = function(_, r, g, b, a)
                                    ...
                                    LilyUI.db.profile.viewers.general.procGlow.loopColor = {r, g, b, a or 1}
                                    if LilyUI.ProcGlow and LilyUI.ProcGlow.RefreshAll then
                                        LilyUI.ProcGlow:RefreshAll()
                                    end
                                end,
                            ...
                            lcgLines = {
                                ...
                                set = function(_, val)
                                    ...
                                    LilyUI.db.profile.viewers.general.procGlow.lcgLines = val
                                    if LilyUI.ProcGlow and LilyUI.ProcGlow.RefreshAll then
                                        LilyUI.ProcGlow:RefreshAll()
                                    end
                                end,
                            ...
                            lcgFrequency = {
                                ...
                                set = function(_, val)
                                    ...
                                    LilyUI.db.profile.viewers.general.procGlow.lcgFrequency = val
                                    if LilyUI.ProcGlow and LilyUI.ProcGlow.RefreshAll then
                                        LilyUI.ProcGlow:RefreshAll()
                                    end
                                end,
                            ...
                            lcgThickness = {
                                ...
                                set = function(_, val)
                                    ...
                                    LilyUI.db.profile.viewers.general.procGlow.lcgThickness = val
                                    if LilyUI.ProcGlow and LilyUI.ProcGlow.RefreshAll then
                                        LilyUI.ProcGlow:RefreshAll()
                                    end
                                end,
    ...
    if profileOptions then
        ...
        if options.args.profiles.handler and options.args.profiles.handler.db ~= self.db then
            error("lilyUI: Profile options handler is not bound to the correct database! This will cause profile conflicts with other addons.")
        end
        
        -- Store a reference to our database for use in closures
        -- This ensures all profile operations use LilyUI's database and never affect other addons
            ...
            options.args.profiles.args.createProfile = {
                ...
                func = function(info)
                    if not profileBuffers.new or profileBuffers.new == "" then
                        print("|cffff0000LilyUI: Please enter a profile name.|r")
                        return
                    end
                    -- Trim whitespace
                    profileBuffers.new = profileBuffers.new:gsub("^%s+", ""):gsub("%s+$", "")
                    if profileBuffers.new == "" then
                        print("|cffff0000LilyUI: Please enter a valid profile name.|r")
                        return
                    end
                    
                    -- Directly call SetProfile on OUR database - this will create the profile if it doesn't exist
                    -- Use the stored reference to ensure we're always using LilyUI's database
                    if nephDB then
                        ...
                        if success then
                            ...
                            if profileExists then
                                print("|cff00ff00LilyUI: Profile '" .. profileName .. "' created successfully. Please reload your UI.|r")
                            else
                                print("|cffff0000LilyUI: Profile creation may have failed. Please reload your UI and check if the profile exists.|r")
                            end
                        else
                            print("|cffff0000LilyUI: Failed to create profile: " .. (err or "Unknown error") .. "|r")
                        end
                    else
                        ...
                        if originalSet then
                            if type(originalSet) == "string" then
                                ...
                                if handlerToUse and handlerToUse.db == nephDB and handlerToUse[originalSet] then
                                    ...
                                    print("|cff00ff00LilyUI: Profile '" .. profileBuffers.new .. "' created successfully. Please reload your UI.|r")
                                else
                                    print("|cffff0000LilyUI: Failed to create profile: Handler not available or wrong database.|r")
                                end
                            ...
                            print("|cffff0000LilyUI: Failed to create profile: No profile creation method available.|r")
                        end
                    end
            ...
            options.args.profiles.args.copyProfile = {
                ...
                func = function(info)
                    if not profileBuffers.copyFrom or profileBuffers.copyFrom == "" then
                        print("|cffff0000LilyUI: Please select a profile to copy from.|r")
                        return
                    end
                    ...
                    print("|cff00ff00LilyUI: Profile copied successfully.|r")
                end,
            }
        end
            ...
            options.args.profiles.args.deleteProfile = {
                ...
                func = function(info)
                    if not profileBuffers.delete or profileBuffers.delete == "" then
                        print("|cffff0000LilyUI: Please select a profile to delete.|r")
                        return
                    end
        ...
        if not StaticPopupDialogs["NEPHUI_DELETE_PROFILE"] then
            StaticPopupDialogs["NEPHUI_DELETE_PROFILE"] = {
                ...
                OnAccept = function(self, data)
                    ...
                    print("|cff00ff00LilyUI: Profile deleted successfully.|r")
                end,
                timeout = 0,
                whileDead = true,
                hideOnEscape = true,
        ...
        if options.args.profiles.args and options.args.profiles.args.reset then
            ...
            options.args.profiles.args.reset.func = function(info)
                ...
                if handlerToUse and handlerToUse.db == nephDB and handlerToUse.Reset then
                    handlerToUse:Reset()
                    print("|cff00ff00LilyUI: Profile reset to defaults. Please reload your UI.|r")
    ...
    options.args.enableUnitFrameAnchors = {
        ...
        func = function()
            ...
            if LilyUI.UnitFrames then
                ...
                print("|cff00ff00[LilyUI] Unit frame anchors enabled|r")
            else
                print("|cffff0000[LilyUI] Unit frames not initialized|r")
            end
        end,
    }
    ...
    options.args.disableUnitFrameAnchors = {
        ...
        func = function()
            ...
            if LilyUI.UnitFrames then
                LilyUI.UnitFrames:UpdateEditModeAnchors()
                print("|cff00ff00[LilyUI] Unit frame anchors disabled|r")
            else
                print("|cffff0000[LilyUI] Unit frames not initialized|r")
            end
        end,
    ...
    options.args.version = {
        type = "description",
        name = function()
            return "|cff00ff00LilyUI v" .. (C_AddOns.GetAddOnMetadata(ADDON_NAME, "Version") or "Unknown") .. "|r"
        end,
        order = 201,
    }
...
function LilyUI:DisableUnitFrameAnchorsOnConfigClose()
