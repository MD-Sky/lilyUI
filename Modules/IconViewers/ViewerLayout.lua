        ...
        if IsCooldownIconFrame(child) then
            ...
            elseif collectAllIcons or child:IsShown() then
                ...
                if not child.__cdmSkinned and not child.__cdmSkinPending then
                    ...
                    if inCombat then
                        LilyUI.__cdmPendingIcons = LilyUI.__cdmPendingIcons or {}
                        LilyUI.__cdmPendingIcons[child] = { icon = child, settings = settings, viewer = viewer }

                        if not LilyUI.__cdmIconSkinEventFrame then
                            ...
                            LilyUI.__cdmIconSkinEventFrame = eventFrame
                        end
                        LilyUI.__cdmIconSkinEventFrame:RegisterEvent("PLAYER_REGEN_ENABLED")
                    else
...
LilyUI.ApplyViewerLayout = function(self, viewer) return IconViewers:ApplyViewerLayout(viewer) end
LilyUI.RescanViewer = function(self, viewer) return IconViewers:RescanViewer(viewer) end
