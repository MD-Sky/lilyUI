...
LilyUI.CharacterPanel = LilyUI.CharacterPanel or {}
local CharacterPanel = LilyUI.CharacterPanel
...
if isMop then
    ...
    scanningTooltip = CreateFrame("GameTooltip", "LilyUIBCPScanningTooltip", nil, "GameTooltipTemplate")
    ...
    function GetItemEnchantAsText(unit, slot)
        ...
        for i = scanningTooltip:NumLines(), 3, -1 do
            local fontString = _G["LilyUIBCPScanningTooltipTextLeft" .. i]
    ...
    function GetSocketTextures(unit, slot)
        ...
        for i = 1, 10 do
            local texture = _G["LilyUIBCPScanningTooltipTexture" .. i]
...
local function GetDB()
    ...
    if not LilyUI.db.profile.qol then
        LilyUI.db.profile.qol = {}
    end
