...
LilyUI.BuffDebuffFrames = LilyUI.BuffDebuffFrames or {}
local BDF = LilyUI.BuffDebuffFrames
...
function BDF:RefreshAll()
    ...
    if LilyUI.db.profile.buffDebuffFrames and LilyUI.db.profile.buffDebuffFrames.enabled then
        ProcessBuffFrames()
        ProcessDebuffFrames()
        HookAuraUpdates()
    end
