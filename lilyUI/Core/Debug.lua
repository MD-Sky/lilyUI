...
SlashCmdList.LILYDEBUG = function(msg)
    ...
    if msg == "clickcast" or msg == "click cast" then
        ...
        LilyUI:DebugLog("ClickCast dump:")
        LilyUI:DebugLog("- UF present: " .. tostring(hasUF))
        LilyUI:DebugLog("- UF.ClickCast namespace: " .. tostring(hasClickCastNS))
        LilyUI:DebugLog("- Enabled: " .. tostring(enabled))
        LilyUI:DebugLog("- Runtime bindings: " .. tostring(bindCount))
        LilyUI:DebugLog("- InCombatLockdown: " .. tostring(InCombatLockdown and InCombatLockdown() or false))
        Debug:Toggle(true)
        return
    end

    LilyUI:DebugLog("Usage: /lilydebug (toggle) | /lilydebug clear | /lilydebug clickcast")
    Debug:Toggle(true)
end
