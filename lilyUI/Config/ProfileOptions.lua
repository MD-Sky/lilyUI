    ...
    return {
        ...
        args = {
            ...
            export = {
                ...
                multiline = true,
                get       = function()
                    return LilyUI:ExportProfileToString()
                end,
                set       = function() end,
            },
            ...
            importButton = {
                ...
                func  = function()
                    ...
                    if not importString or importString == "" then
                        print("|cffff0000" .. (L["lilyUI: Import failed: No data found. Please paste your import string in the Import Profile String field."] or "lilyUI: Import failed: No data found. Please paste your import string in the Import Profile String field.") .. "|r")
                        return
                    end
                    ...
                    if not newProfileName or newProfileName == "" then
                        print("|cffff0000" .. (L["lilyUI: Please enter a profile name for the imported profile."] or "lilyUI: Please enter a profile name for the imported profile.") .. "|r")
                        return
                    end
                    
                    local ok, err = LilyUI:ImportProfileFromString(importString, newProfileName)
                    if ok then
                        print("|cff00ff00" .. (L["lilyUI: Profile imported as '%s'. Please reload your UI."] or "lilyUI: Profile imported as '%s'. Please reload your UI."):format(newProfileName) .. "|r")
                        -- Clear the buffers after successful import
                        importBuffer = ""
                        newProfileNameBuffer = ""
                    else
                        local errMsg = L["lilyUI: Import failed: %s"] or "lilyUI: Import failed: %s"
