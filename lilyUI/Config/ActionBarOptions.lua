    ...
    return {
        ...
        args = {
            ...
            enabled = {
                ...
                desc = "Apply custom LilyUI styling to action bars",
                width = "full",
                order = 2,
                get = function() return LilyUI.db.profile.actionBars.enabled end,
                set = function(_, val)
                    LilyUI.db.profile.actionBars.enabled = val
                    if LilyUI.ActionBars and LilyUI.ActionBars.RefreshAll then
                        LilyUI.ActionBars:RefreshAll()
                    end
                end,
            },
            borderSize = {
                ...
                order = 3,
                get = function()
                    return LilyUI.db.profile.actionBars.borderSize or 1
                end,
                set = function(_, val)
                    LilyUI.db.profile.actionBars.borderSize = val
                    if LilyUI.ActionBars and LilyUI.ActionBars.RefreshAll then
                        LilyUI.ActionBars:RefreshAll()
                    end
                end,
            ...
            borderColor = {
                ...
                hasAlpha = true,
                get = function()
                    local c = LilyUI.db.profile.actionBars.borderColor or {0, 0, 0, 1}
                    return c[1], c[2], c[3], c[4] or 1
                end,
                set = function(_, r, g, b, a)
                    LilyUI.db.profile.actionBars.borderColor = { r, g, b, a or 1 }
                    if LilyUI.ActionBars and LilyUI.ActionBars.RefreshAll then
                        LilyUI.ActionBars:RefreshAll()
                    end
                end,
            ...
            backdropColor = {
                ...
                hasAlpha = true,
                get = function()
                    local c = LilyUI.db.profile.actionBars.backdropColor
                    return c[1], c[2], c[3], c[4] or 1
                end,
                set = function(_, r, g, b, a)
                    LilyUI.db.profile.actionBars.backdropColor = { r, g, b, a or 1 }
                    if LilyUI.ActionBars and LilyUI.ActionBars.RefreshAll then
                        LilyUI.ActionBars:RefreshAll()
                    end
                end,
            ...
            font = {
                ...
                get = function()
                    local font = LilyUI.db.profile.actionBars.font
                    return font or ""
                end,
                set = function(_, val)
                    if val == "" then
                        LilyUI.db.profile.actionBars.font = nil
                    else
                        LilyUI.db.profile.actionBars.font = val
                    end
                    if LilyUI.ActionBars and LilyUI.ActionBars.RefreshAll then
                        LilyUI.ActionBars:RefreshAll()
                    end
            ...
            mouseoverEnabled = {
                ...
                order = 31,
                get = function() 
                    local cfg = LilyUI.db.profile.actionBars.mouseover
                    return cfg and cfg.enabled or false
                end,
                set = function(_, val)
                    if not LilyUI.db.profile.actionBars.mouseover then
                        LilyUI.db.profile.actionBars.mouseover = {}
                    end
                    LilyUI.db.profile.actionBars.mouseover.enabled = val
                    if LilyUI.ActionBars and LilyUI.ActionBars.RefreshAll then
                        LilyUI.ActionBars:RefreshAll()
                    end
                end,
            ...
            mouseoverAlpha = {
                ...
                set = function(_, val)
                    ...
                    LilyUI.db.profile.actionBars.mouseover.alpha = val
                    if LilyUI.ActionBars and LilyUI.ActionBars.RefreshAll then
                        LilyUI.ActionBars:RefreshAll()
                    end
                end,
            ...
            mouseoverBar1 = {
                ...
                set = function(_, val)
                    ...
                    if not LilyUI.db.profile.actionBars.mouseover.bars then
                        LilyUI.db.profile.actionBars.mouseover.bars = {}
                    end
                    LilyUI.db.profile.actionBars.mouseover.bars.bar1 = val
                    if LilyUI.ActionBars and LilyUI.ActionBars.RefreshAll then
                        LilyUI.ActionBars:RefreshAll()
                    end
                end,
            ...
            mouseoverBar2 = {
                ...
                set = function(_, val)
                    ...
                    LilyUI.db.profile.actionBars.mouseover.bars.bar2 = val
                    if LilyUI.ActionBars and LilyUI.ActionBars.RefreshAll then
                        LilyUI.ActionBars:RefreshAll()
                    end
                end,
            ...
            mouseoverBar3 = {
                ...
                set = function(_, val)
                    ...
                    LilyUI.db.profile.actionBars.mouseover.bars.bar3 = val
                    if LilyUI.ActionBars and LilyUI.ActionBars.RefreshAll then
                        LilyUI.ActionBars:RefreshAll()
                    end
                end,
            ...
            mouseoverBar4 = {
                ...
                set = function(_, val)
                    ...
                    LilyUI.db.profile.actionBars.mouseover.bars.bar4 = val
                    if LilyUI.ActionBars and LilyUI.ActionBars.RefreshAll then
                        LilyUI.ActionBars:RefreshAll()
                    end
                end,
            ...
            mouseoverBar5 = {
                ...
                set = function(_, val)
                    ...
                    LilyUI.db.profile.actionBars.mouseover.bars.bar5 = val
                    if LilyUI.ActionBars and LilyUI.ActionBars.RefreshAll then
                        LilyUI.ActionBars:RefreshAll()
                    end
                end,
            ...
            mouseoverBar6 = {
                ...
                set = function(_, val)
                    ...
                    LilyUI.db.profile.actionBars.mouseover.bars.bar6 = val
                    if LilyUI.ActionBars and LilyUI.ActionBars.RefreshAll then
                        LilyUI.ActionBars:RefreshAll()
                    end
                end,
            ...
            mouseoverBar7 = {
                ...
                set = function(_, val)
                    ...
                    LilyUI.db.profile.actionBars.mouseover.bars.bar7 = val
                    if LilyUI.ActionBars and LilyUI.ActionBars.RefreshAll then
                        LilyUI.ActionBars:RefreshAll()
                    end
                end,
            ...
            mouseoverBar8 = {
                ...
                set = function(_, val)
                    ...
                    LilyUI.db.profile.actionBars.mouseover.bars.bar8 = val
                    if LilyUI.ActionBars and LilyUI.ActionBars.RefreshAll then
                        LilyUI.ActionBars:RefreshAll()
                    end
                end,
            ...
            mouseoverPetBar = {
                ...
                set = function(_, val)
                    ...
                    LilyUI.db.profile.actionBars.mouseover.bars.petBar = val
                    if LilyUI.ActionBars and LilyUI.ActionBars.RefreshAll then
                        LilyUI.ActionBars:RefreshAll()
                    end
                end,
            ...
            mouseoverStanceBar = {
                ...
                set = function(_, val)
                    ...
                    LilyUI.db.profile.actionBars.mouseover.bars.stanceBar = val
                    if LilyUI.ActionBars and LilyUI.ActionBars.RefreshAll then
                        LilyUI.ActionBars:RefreshAll()
                    end
                end,
            ...
            mouseoverMicroMenu = {
                ...
                set = function(_, val)
                    ...
                    LilyUI.db.profile.actionBars.mouseover.bars.microMenu = val
                    if LilyUI.ActionBars and LilyUI.ActionBars.RefreshAll then
                        LilyUI.ActionBars:RefreshAll()
                    end
                end,
            ...
            keybindHide = {
                ...
                order = 51,
                get = function()
                    local cfg = LilyUI.db.profile.actionBars.keybindText
                    return cfg and cfg.hide or false
                end,
                set = function(_, val)
                    if not LilyUI.db.profile.actionBars.keybindText then
                        LilyUI.db.profile.actionBars.keybindText = {}
                    end
                    LilyUI.db.profile.actionBars.keybindText.hide = val
                    if LilyUI.ActionBars and LilyUI.ActionBars.RefreshAll then
                        LilyUI.ActionBars:RefreshAll()
                    end
                end,
            ...
            keybindColor = {
                ...
                set = function(_, r, g, b, a)
                    ...
                    LilyUI.db.profile.actionBars.keybindText.fontColor = { r, g, b, a or 1 }
                    if LilyUI.ActionBars and LilyUI.ActionBars.RefreshAll then
                        LilyUI.ActionBars:RefreshAll()
                    end
                end,
            ...
            keybindSize = {
                ...
                set = function(_, val)
                    ...
                    LilyUI.db.profile.actionBars.keybindText.fontSize = val
                    if LilyUI.ActionBars and LilyUI.ActionBars.RefreshAll then
                        LilyUI.ActionBars:RefreshAll()
                    end
                end,
            ...
            keybindOffsetX = {
                ...
                set = function(_, val)
                    ...
                    LilyUI.db.profile.actionBars.keybindText.offsetX = val
                    if LilyUI.ActionBars and LilyUI.ActionBars.RefreshAll then
                        LilyUI.ActionBars:RefreshAll()
                    end
                end,
            ...
            keybindOffsetY = {
                ...
                set = function(_, val)
                    ...
                    LilyUI.db.profile.actionBars.keybindText.offsetY = val
                    if LilyUI.ActionBars and LilyUI.ActionBars.RefreshAll then
                        LilyUI.ActionBars:RefreshAll()
                    end
                end,
            ...
            macroHide = {
                ...
                order = 61,
                get = function()
                    local cfg = LilyUI.db.profile.actionBars.macroText
                    return cfg and cfg.hide or false
                end,
                set = function(_, val)
                    if not LilyUI.db.profile.actionBars.macroText then
                        LilyUI.db.profile.actionBars.macroText = {}
                    end
                    LilyUI.db.profile.actionBars.macroText.hide = val
                    if LilyUI.ActionBars and LilyUI.ActionBars.RefreshAll then
                        LilyUI.ActionBars:RefreshAll()
                    end
                end,
            ...
            macroColor = {
                ...
                set = function(_, r, g, b, a)
                    ...
                    LilyUI.db.profile.actionBars.macroText.fontColor = { r, g, b, a or 1 }
                    if LilyUI.ActionBars and LilyUI.ActionBars.RefreshAll then
                        LilyUI.ActionBars:RefreshAll()
                    end
                end,
            ...
            macroSize = {
                ...
                set = function(_, val)
                    ...
                    LilyUI.db.profile.actionBars.macroText.fontSize = val
                    if LilyUI.ActionBars and LilyUI.ActionBars.RefreshAll then
                        LilyUI.ActionBars:RefreshAll()
                    end
                end,
            ...
            macroOffsetX = {
                ...
                set = function(_, val)
                    ...
                    LilyUI.db.profile.actionBars.macroText.offsetX = val
                    if LilyUI.ActionBars and LilyUI.ActionBars.RefreshAll then
                        LilyUI.ActionBars:RefreshAll()
                    end
                end,
            ...
            macroOffsetY = {
                ...
                set = function(_, val)
                    ...
                    LilyUI.db.profile.actionBars.macroText.offsetY = val
                    if LilyUI.ActionBars and LilyUI.ActionBars.RefreshAll then
                        LilyUI.ActionBars:RefreshAll()
                    end
                end,
            ...
            countHide = {
                ...
                order = 71,
                get = function()
                    local cfg = LilyUI.db.profile.actionBars.countText
                    return cfg and cfg.hide or false
                end,
                set = function(_, val)
                    if not LilyUI.db.profile.actionBars.countText then
                        LilyUI.db.profile.actionBars.countText = {}
                    end
                    LilyUI.db.profile.actionBars.countText.hide = val
                    if LilyUI.ActionBars and LilyUI.ActionBars.RefreshAll then
                        LilyUI.ActionBars:RefreshAll()
                    end
                end,
            ...
            countColor = {
                ...
                set = function(_, r, g, b, a)
                    ...
                    LilyUI.db.profile.actionBars.countText.fontColor = { r, g, b, a or 1 }
                    if LilyUI.ActionBars and LilyUI.ActionBars.RefreshAll then
                        LilyUI.ActionBars:RefreshAll()
                    end
                end,
            ...
            countSize = {
                ...
                set = function(_, val)
                    ...
                    LilyUI.db.profile.actionBars.countText.fontSize = val
                    if LilyUI.ActionBars and LilyUI.ActionBars.RefreshAll then
                        LilyUI.ActionBars:RefreshAll()
                    end
                end,
            ...
            countOffsetX = {
                ...
                set = function(_, val)
                    ...
                    LilyUI.db.profile.actionBars.countText.offsetX = val
                    if LilyUI.ActionBars and LilyUI.ActionBars.RefreshAll then
                        LilyUI.ActionBars:RefreshAll()
                    end
                end,
            ...
            countOffsetY = {
                ...
                set = function(_, val)
                    ...
                    LilyUI.db.profile.actionBars.countText.offsetY = val
                    if LilyUI.ActionBars and LilyUI.ActionBars.RefreshAll then
                        LilyUI.ActionBars:RefreshAll()
                    end
                end,
            ...
            glows = {
                ...
                args = {
                    ...
                    procGlowEnabled = {
                        ...
                        order = 11,
                        get = function()
                            local procGlow = LilyUI.db.profile.actionBars.procGlow
                            return procGlow and procGlow.enabled or false
                        end,
                        set = function(_, val)
                            if not LilyUI.db.profile.actionBars.procGlow then
                                LilyUI.db.profile.actionBars.procGlow = {}
                            end
                            LilyUI.db.profile.actionBars.procGlow.enabled = val
                                    if LilyUI.ActionBarGlow and LilyUI.ActionBarGlow.RefreshAll then
                                        LilyUI.ActionBarGlow:RefreshAll()
                                    end
                        end,
                    },
                    procGlowSpacer1 = {
                    ...
                    glowType = {
                        ...
                        set = function(_, val)
                            ...
                            LilyUI.db.profile.actionBars.procGlow.glowType = val
                                    if LilyUI.ActionBarGlow and LilyUI.ActionBarGlow.RefreshAll then
                                        LilyUI.ActionBarGlow:RefreshAll()
                                    end
                        end,
                    ...
                    loopColor = {
                        ...
                        set = function(_, r, g, b, a)
                            ...
                            LilyUI.db.profile.actionBars.procGlow.loopColor = {r, g, b, a or 1}
                                    if LilyUI.ActionBarGlow and LilyUI.ActionBarGlow.RefreshAll then
                                        LilyUI.ActionBarGlow:RefreshAll()
                                    end
                        end,
                    ...
                    lcgLines = {
                        ...
                        set = function(_, val)
                            ...
                            LilyUI.db.profile.actionBars.procGlow.lcgLines = val
                                    if LilyUI.ActionBarGlow and LilyUI.ActionBarGlow.RefreshAll then
                                        LilyUI.ActionBarGlow:RefreshAll()
                                    end
                        end,
                    ...
                    lcgFrequency = {
                        ...
                        set = function(_, val)
                            ...
                            LilyUI.db.profile.actionBars.procGlow.lcgFrequency = val
                                    if LilyUI.ActionBarGlow and LilyUI.ActionBarGlow.RefreshAll then
                                        LilyUI.ActionBarGlow:RefreshAll()
                                    end
                        end,
                    ...
                    lcgThickness = {
                        ...
                        set = function(_, val)
                            ...
                            LilyUI.db.profile.actionBars.procGlow.lcgThickness = val
                                    if LilyUI.ActionBarGlow and LilyUI.ActionBarGlow.RefreshAll then
                                        LilyUI.ActionBarGlow:RefreshAll()
                                    end
                        end,
