...
function CastBars:InitializeEmpoweredStages(bar)
    ...
    C_Timer.After(0, function()
        ...
        local iconWidth = LilyUI:Scale(barHeight)  -- Icon width equals bar height
        ...
        local borderOffset = (LilyUI.ScaleBorder and LilyUI:ScaleBorder(1)) or math.floor((LilyUI:Scale(1) or 1) + 0.5)
...
function CastBars:OnPlayerSpellcastEmpowerStop(unit, castGUID, spellID)
    ...
    if name and startTimeMS and endTimeMS then
        ...
        LilyUI.castBar.isEmpowered = false
        LilyUI.castBar.numStages = 0
...
LilyUI.InitializeEmpoweredStages = function(self, bar) return CastBars:InitializeEmpoweredStages(bar) end
LilyUI.OnPlayerSpellcastEmpowerStart = function(self, unit, castGUID, spellID) return CastBars:OnPlayerSpellcastEmpowerStart(unit, castGUID, spellID) end
LilyUI.OnPlayerSpellcastEmpowerUpdate = function(self, unit, castGUID, spellID) return CastBars:OnPlayerSpellcastEmpowerUpdate(unit, castGUID, spellID) end
LilyUI.OnPlayerSpellcastEmpowerStop = function(self, unit, castGUID, spellID) return CastBars:OnPlayerSpellcastEmpowerStop(unit, castGUID, spellID) end
