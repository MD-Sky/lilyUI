...
LilyUI.Minimap = LilyUI.Minimap or {}
local MinimapModule = LilyUI.Minimap
...
local function UpdateBackdrop()
    ...
    local db = LilyUI.db.profile.minimap
...
local function CreateClock()
    ...
    -- Update font size
    clockDisplay:SetFont(LilyUI:GetGlobalFont(), db.clock.fontSize or 12, "OUTLINE")
...
local function CreateFPS()
    ...
    -- Update font size
    fpsDisplay:SetFont(LilyUI:GetGlobalFont(), db.fps.fontSize or 12, "OUTLINE")
    ...
    local function UpdateFPS()
        ...
        local currentDb = LilyUI.db.profile.minimap
...
local function CreateZoneText()
    ...
    if zoneTextFrame.font then
        zoneTextFrame.font:SetFont(LilyUI:GetGlobalFont(), fontSize, "OUTLINE")
    end
