...
-- Create namespace
LilyUI.AutoUIScale = LilyUI.AutoUIScale or {}
local AutoUIScale = LilyUI.AutoUIScale
...
function AutoUIScale:ApplySavedScale()
    ...
    if LilyUI and LilyUI.db and LilyUI.db.profile and LilyUI.db.profile.general then
