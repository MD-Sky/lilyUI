        ...
        if unit == "pet" then
            ...
            if type(playerClass) == "string" then
                ...
                if playerClassColor then
                    return playerClassColor.r, playerClassColor.g, playerClassColor.b, 1
                end
            end
        end
        ...
        if type(isPlayer) == "boolean" and isPlayer then
            ...
            if type(class) == "string" then
                ...
                if unitClassColor then
                    return unitClassColor.r, unitClassColor.g, unitClassColor.b, 1
                end
            end
        end
    end
    ...
    if DB.Frame.ReactionColor then
        ...
        if type(reaction) == "number" then
            ...
            if reactionColor then
                return reactionColor[1], reactionColor[2], reactionColor[3], 1
            end
        end
    end
...
local MOUSEOVER_HIGHLIGHT_TEXTURE = "Interface\\AddOns\\lilyUI\\Media\\uf_mouseover.tga"

local function GetMouseoverHighlightSettings()
    local profile = LilyUI.db and LilyUI.db.profile and LilyUI.db.profile.unitFrames
