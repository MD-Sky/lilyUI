--[[
    LilyUI Localization - English (enUS)
    Base locale for all English strings
--]]

local ADDON_NAME, ns = ...

-- Register the base (fallback) locale under the *actual* addon name.
-- This must match what other files pass to GetLocale(ADDON_NAME).
...
L["Apply custom LilyUI styling to action bars"] = "Apply custom LilyUI styling to action bars"
...
L["Open the full LilyUI configuration panel"] = "Open the full LilyUI configuration panel"
...
L["Frame name to anchor to (e.g., EssentialCooldownViewer, LilyUI_Player, LilyUI_Target, UIParent)"] = "Frame name to anchor to (e.g., EssentialCooldownViewer, LilyUI_Player, LilyUI_Target, UIParent)"
...
-- MESSAGES & ERRORS
-- ============================================================
L["lilyUI: Import failed: No data found. Please paste your import string in the Import Profile String field."] = "lilyUI: Import failed: No data found. Please paste your import string in the Import Profile String field."
L["lilyUI: Please enter a profile name for the imported profile."] = "lilyUI: Please enter a profile name for the imported profile."
L["lilyUI: Profile imported as '%s'. Please reload your UI."] = "lilyUI: Profile imported as '%s'. Please reload your UI."
L["lilyUI: Profile imported. Please reload your UI."] = "lilyUI: Profile imported. Please reload your UI."
L["lilyUI: Import failed: %s"] = "lilyUI: Import failed: %s"
L["lilyUI: Invalid Import String."] = "lilyUI: Invalid Import String."
...
L["[LilyUI] Warning: Custom GUI not loaded, using AceConfigDialog"] = "[LilyUI] Warning: Custom GUI not loaded, using AceConfigDialog"
L["[LilyUI] Party/Raid frames GUI not loaded."] = "[LilyUI] Party/Raid frames GUI not loaded."
